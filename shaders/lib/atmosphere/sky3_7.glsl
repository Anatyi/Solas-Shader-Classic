//Sky 3.7 Style (ported from Solas Shader 3.7)
//Active only with SKY_3_7 (default off, keeps the 2.3 sky). Depends on:
//spaceFactor/KARMAN_LINE, skyColor, timeBrightness, timeBrightnessSqrt, biomeColor,
//isSpecificBiome, weatherCol, sunVec, sunVisibility, SUNRISE_SUNSET_INTENSITY,
//lightNight, moonVisibility, caveFactor, caveMinLightCol, isCaveBiome, caveBiomeColor,
//wetness, cameraPosition, pow5, fmix.
#ifdef SKY_3_7
#if defined OVERWORLD
vec3 getAtmosphere3_7(vec3 viewPos, vec3 worldPos, out float atmosphereHardMixFactor) {
